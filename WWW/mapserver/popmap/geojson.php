    ...
    "features":[
        ...
        {"type": "Feature",
            ...
            "properties":{
                ...
                "description": "<a href='http://scenemodels.flightgear.org/objectview.php?id=<?php echo $row["ob_id"];?>' target='_blank'><img src='http://scenemodels.flightgear.org/modelthumb.php?id=<?php echo $row["ob_model"];?>' alt=''/></a>"
            },
            "geometry":{
