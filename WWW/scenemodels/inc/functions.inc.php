...
function detect_already_existing_object($lat, $lon, $ob_gndelev, $ob_elevoffset, $ob_heading, $ob_model)
{
    ...
    $query = "SELECT ob_id FROM fgs_objects WHERE wkb_geometry = ST_PointFromText('POINT(".$lon." ".$lat.")', 4326) AND ob_gndelev =".$ob_gndelev." AND ob_elevoffset =".$ob_elevoffset." AND ob_heading =".$ob_heading." AND ob_model=".$ob_model.";";
