...
function drawVisualization() {
    ...
    dataObjects.addRows([
        ...
        [new Date(<?php echo date('Y,n,j')."), ".$objects.", ".$models.", ".$signs; ?> ]]);
...
echo "<p class=\"center\">The database currently contains <a href=\"models.php\">".number_format($models, '0', '', ' ')." models</a> placed in the scenery as <a href=\"objects.php\">".number_format($objects, '0', '', ' ')." seperate objects</a>, plus $signs taxiway signs.</p>\n";
