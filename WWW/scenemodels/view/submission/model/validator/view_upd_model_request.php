...
<?php
            ...
            foreach ($texturesNames as $textureName) {
                $texture_file = "http://".$_SERVER['SERVER_NAME'] ."/app.php?c=UpdateModelValidator&a=getOldModelTexture&sig=".$sig."&name=".$textureName;
                $texture_file_tn = "http://".$_SERVER['SERVER_NAME'] ."/app.php?c=UpdateModelValidator&a=getOldModelTexture&sig=".$sig."&name=".$textureName;
