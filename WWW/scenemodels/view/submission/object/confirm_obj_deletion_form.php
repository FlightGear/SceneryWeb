...
/*]]>*/
    ...
    <table>
        ...
        <tr>
            ...
            <td><object data="http://mapserver.flightgear.org/popmap/?lon=<?=$objDelPos->getLongitude()?>&amp;lat=<?=$objDelPos->getLatitude()?>&amp;zoom=14" type="text/html" width="300" height="225"></object></td>
        </tr>
        <tr>
