        ...
        <div id="tabs-2">
            <table>
                <tr>
                    ...
                    <td>
                        <input type="text" name="long1" id="long1" maxlength="13" value="" onkeyup="checkNumeric(form['long1'],-180,180);validateTabs();" onchange="update_map('long1','lat1');update_country('long1','lat1');" />
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="lat1" id="lat1" maxlength="13" value="" onkeyup="checkNumeric(form['lat1'],-90,90);validateTabs();" onchange="update_map('long1','lat1');update_country('long1','lat1');" />
                    </td>
                </tr>
                <tr>
