...
?>
        ...
        <tr>
            ...
            <td><center><a href="http://<?php echo $_SERVER['SERVER_NAME'];?>/app.php?c=Models&amp;a=view&amp;id=<?php $model_id = $candidateObj->getModelId(); echo $model_id; ?>"><img src="app.php?c=Models&amp;a=thumbnail&amp;id=<?php echo $model_id; ?>" alt="Thumbnail"/></a></center></td>
