...
rm -f ${SCENERY_PACK}
ln -s . ${SCENERY_PACK}
tar --create --owner=root --group=root --gzip --file=$OUTPUTDIR/${SCENERY_PACK}.tgz ${SCENERY_PACK}/Objects/e000n40/e00[789]n4[67] ${SCENERY_PACK}/Terrain/e000n40/e00[789]n4[67] ${SCENERY_PACK}/Airports ${SCENERY_PACK}/Models
rm ${SCENERY_PACK}
